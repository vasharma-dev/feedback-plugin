// Lightweight inline SVG icons (no icon-library dependency). Each inherits color
// via `currentColor` and accepts a className for sizing.
...
export const BugIcon = ({ className }: P) => (
  <svg {...base(className)}>
    <path d="m8 2 1.88 1.88M14.12 3.88 16 2M9 7.13v-1a3.003 3.003 0 1 1 6 0v1" />
    <path d="M12 20c-3.3 0-6-2.7-6-6v-3a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v3c0 3.3-2.7 6-6 6ZM12 20v-9M6 13H2M3 21l3-3M20 8h2M22 21l-3-3M6 8H2" />
  </svg>
);
